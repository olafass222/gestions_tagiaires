...
- `PUT    /api/encadrants/mettre_a_jour_encadrant` : mettre à jour un encadrant (body complet) ([github.com](https://github.com/olafass222/gestions_tagiaires/blob/main/backend/src/main/java/com/example/gestionstagiaires/resource/EncadrantController.java))
...
- `PUT    /api/stagiaires/metter_a_jour_stagiaire` : mettre à jour un stagiaire ([github.com](https://github.com/olafass222/gestions_tagiaires/blob/main/backend/src/main/java/com/example/gestionstagiaires/resource/StagiaireController.java))
